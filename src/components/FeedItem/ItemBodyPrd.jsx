...
import 'swiper/css';
import styles from './ItemBodyPrd.module.css'

import icoLike from '../../assets/ico_like.svg';
import icoStar from '../../assets/ico_star.svg';


export default function ItemBodyPrd({feedData}) {
	return (
